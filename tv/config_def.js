...
config['tv'] = {
	...
	'volume_control': 'native', //'native','hoteza'
	'mosaic_clock': {
		'enabled': false
	},
	...
	'welcome_screen': { //object {'channel': 2, 'volume': 10}
		'enabled': true,
		'always': true,
		'channel': 0,
		'volume': 10,
	...
	'parental_lock': false,
	'sleep_timer': { //For custom timers add "data": [10,20,30] (mins)
		'enabled': true 
	},
	'checkin_action': '',
